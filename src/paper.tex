...
\begin{table}
    ...
    \begin{center}
        \begin{tabular}{llllll}
            System                & type & size & DNSMOS & dWER   & Sim  \\
            Mixture               & -          & -          & 2.68   & 79.3\% & -        \\
            Target & -          & -          & 3.32   & 11.3\% & 0.653    \\
                                  &            &            &        &        &          \\
            Spex+                 & Continuous & 11M        & 2.98   & 19.3\% & 0.923    \\
            Continuous     & Continuous & 220M       & 3.27   & 14.7\% & 0.877    \\
            TSELM       & Hybrid     & 468M       & 3.22   & 19.8\% & 0.924\_d \\
                                  &            &            &        &        &          \\
            TSELM-S               & Discrete   & 354M       & 3.24   & 28.1\% & 0.892\_d \\
            TSELM-M               & Discrete   & 389M       & 3.22   & 28.4\% & 0.901\_d \\
            TSELM-L               & Discrete   & 468M       & 3.22   & 27.1\% & 0.905\_d
            \end{tabular}
      \end{center}
      \caption{This table }
  \end{table}
...
TSELM is compared with 


% \subsubsection{Test sets}
% We use the \texttt{dev} set of Libri2Mix \cite{librimix} to test our model performance and other baseline models. 

% \subsubsection{Evaluation Metrics}
% As mentioned in studies 
...
%     \hline
%     System & Type & Model size & DNSMOS & dWER & Spk Sim 
% \end{table*}
% % \end{center}
