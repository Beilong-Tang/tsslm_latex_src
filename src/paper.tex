...
We use the output from hidden layers 1, 3, 7, 12, 18, 23 from WavLM Large for tokenization. 
We use embedding dimension 1024, sinusoidal positional embedding, and 4 transformer 
...
sharing embeddings does slightly better than sharing embeddings. The small version of TSELM-S uses 
embedding dimension \(d\) = 256, absolute sinusoidal positional embedding, and there are 
