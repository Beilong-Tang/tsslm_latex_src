...
\title{Target Speaker Extraction using Discrete Representations from Self-Supervised Models and Language Models
...
enhancement \cite{selm} and blind speech separation \cite{dasb}, however, this approach has 
been rarely studied for target speaker extraction. TokenSplit \cite{tokensplit} utilizes 
Large Language Model to do blind speech separation instead of target speaker extraction. 
Also, it  needs the 
transcript of the speech to achieve satisfying results. In 
real life, however, speech is rarely provided with its transcript.
