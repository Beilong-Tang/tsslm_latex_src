...
We use the pretrained WavLM Large \cite{wavlm} and it is freezed during training. The Kmeans tokenizer is trained on the 
is trained on the \texttt{train\_clean\_100}, \texttt{train\_clean\_360}, and \texttt{train\_other\_500} of
LibriSpeech. 
