...
Baseline models are reflected in Table \ref{main_exp}. 
...
similarity of TSELM with the target audio produced by discretizing the clean audio, which is denoted by Target-Discrete, and it is the upper bound of our model  
performance. Besides TSELM, we did three main experiments 
