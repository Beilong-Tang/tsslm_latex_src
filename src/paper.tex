...
Discretization methods have been studied for speech enhancement \cite{selm} and blind speech separation \cite{dasb}, however, this approach has been rarely for target speaker extraction. TokenSplit \cite{tokensplit} needs the transcript of the speech to achieve satisfying results. In 
