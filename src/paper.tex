...
Experiments have 
shown that our model can achieve excellent performance in terms of speech quality, and comparable performance in terms of speech intelligibility. However, our model relies on WavLM's denoising property, and future work should focus on developing speaker-aware tokenization method.
