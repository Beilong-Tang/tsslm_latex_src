...
The key factor in target speaker extraction is to inject the information of target speaker 
into the mixture. SEF-Net \cite{sef_net} has proposed an embedding free way to inject the 
target speaker information into the mixture by using cross attention module. This approach 
has 
