...
denoted by Continuous-WavLM and TSELM-L-Hybrid. For Continuous-WavLM, we directly
passed the embeddings of the 6th hidden layer output of WavLM to the cross attention  
and LM, using Mean Square Error loss between the output embeddings and the clean 
embeddings. We then reconstruct the audio back to the 
